...
$passworda = "";
$dbname = "biydaalt";
$conn = mysqli_connect($server, $username, $passworda, $dbname);
$user_id = null;
$full_name = "";
$email = "";
$password = "";
...
if ($_POST) {
	...
	$sql = "INSERT INTO `user` (`user_id`, `user_fname`, `user_email`,`user_pass`,`user_pass_repeat`)
VALUES ('$user_id', '$full_name','$email','$password','$passwordrepeat')";
			...
			<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
				...
				<div class="d-flex flex-column-fluid flex-center">
					...
					<div class="login-form login-signin">
						<!--begin::Form-->
						<form class="form" novalidate="novalidate" id="kt_login_signin_form" method="POST" action="login.php">
							<!--begin::Title-->
							...
							<div class="pb-lg-0 pb-5">
								<input type="submit" name="sign" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3"></button>
					...
					<div class="login-form login-signup">
						<!--begin::Form-->
						<form class="form" method="POST" name="register" novalidate="novalidate" id="kt_login_signup_form">
							<!--begin::Title-->
							<div class="pb-13 pt-lg-0 pt-5">
							...
							<div class="form-group d-flex flex-wrap pb-lg-0 pb-3">
								<input type="submit" name="sub" value="Sul" id="" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-4"></button>

...
<script>
    function addvideo() {
        ...
        if (name != "" && director != "" && duration != "" && release != "" && url != "" && category != "") {
            ...
            xml.open("POST", "http://localhost/demo1/dist/actionPhp/addVideo.php", true);
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div style="width: 600px;">
                                <div>Video нэр:</div><br>
                                <input class="form-control" type="text" id="vname"><br>
                                <div>Найруулагч:</div><br>
                                <input class="form-control" type="text" id="director"><br>
                                <div>Үргэлжлэх хугацаа:</div><br>
                                <input class="form-control" type="text" id="duration"><br>
                                <div>Гарсан он:</div><br>
                                <input class="form-control" type="text" id="release"><br>
                                <div>Trailer url:</div><br>
                                <input class="form-control" type="text" id="url"><br>
                                <div>Image url:</div><br>
                                <input class="form-control" type="text" id="imgurl"><br>
                                <div>Видеоны төрөл:</div><br>
                                ...
                                <br>
                                <div class="text-left">
                                    <button onclick="addvideo()" type="button" class="btn btn-primary text-weight-bold">Шинэ видео оруулах</button>
                                </div>
                            </div>
                            <!--end::Dashboard-->
                        </div>

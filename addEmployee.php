...
<script>
    function addemployee() {
        ...
        var urpass = document.getElementById("urpass").value;
        var uphone = document.getElementById("uphone").value;
        if(upass != urpass){
            alert("Баталгаажуулах пассворд буруу байна")
        }else
        if (name != "" && ufname!=""&& upass!=""&& urpass!=""&& uphone!="") {            var xml = new XMLHttpRequest();
            xml.onreadystatechange = function() {
                if (xml.readyState == 4 && xml.status == 200) {
                    console.log(xml.response)
                    if (xml.response == 'suc') {
                        alert('Ажилтан нэмэгдлээ')
                        window.location = "http://localhost/demo1/dist/index.php";  
                    } else {
                        alert("aldaa garlaa" + xml.response)
                    }

                }
            }
            xml.open("POST", "http://localhost/demo1/dist/actionPhp/addEmployeeRes.php", true);
            xml.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
            xml.send("username=" + name +
                "&fullname=" + ufname +
                "&pass=" + upass +
                "&passr=" + urpass +
                "&phone=" + uphone )
        } else {
            alert("Ямар нэр юм дутуу байна")
        }
    }
                    ...
                    <div class="d-flex flex-column-fluid">
                        ...
                        <div class="container">
                            ...
                            <div style="width: 600px;">
                                <div>Ажилтны нэр:</div><br>
                                <input class="form-control" type="text" id="ename"><br>
                                <div>Ажилтны овог:</div><br>
                                <input class="form-control" type="text" id="ufname"><br>
                                <div>Ажилтны пасс:</div><br>
                                <input class="form-control" type="text" id="upass"><br>
                                <div>Ажилтны пасс баталгаажуулах:</div><br>
                                <input class="form-control" type="text" id="urpass"><br>
                                <div>Ажилтны утас:</div><br>
                                <input class="form-control" type="text" id="uphone"><br>
                                <br>
                                <br>
                                <div class="text-left">
                                    <button onclick="addemployee()" type="button" class="btn btn-primary text-weight-bold">Шинэ видео оруулах</button>
                                </div>
                            </div>
                            <!--end::Dashboard-->
                        </div>
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="text-muted mt-1">Худалдагч</div>
                    <div class="navi mt-2">
